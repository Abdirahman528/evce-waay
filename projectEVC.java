...
public class projectEVC {
    public static void main(String[] args) {
        ...
        //  hubi  USSD-code haduu saxanyahay
        ...
        if (pinentering1 == pinentering2) {
            ...
            int choosingPhase2 = input.nextInt(); // User qebta u doranaayo way

            // qeebta 1: Show Balance
            if (choosingPhase2 == 1) {
                System.out.println("Haraagaaga waa $" + haraaga);
            }

            //  qeebta 2: Kaarka Hadalka
